...
import signupAnimation from "../assets/animation/avocado-workout.json";
import AOS from "aos";
import "aos/dist/aos.css";
import CreateNewUser from "../../Apis/SignupApi";
...
const Signup = () => {
 ...
 async function handleSubmit (){
     ...
     let req = await CreateNewUser(data)
 ...
 const handleBoth = () => {
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center signup-container">
      ...
      <div
        className="container position-relative signup-content"
         data-aos="zoom-in"
                data-aos-delay="200"
      >
          ...
          <div className="">
            <div className="card border-0 overflow-hidden signup-card">
              <div className="row g-0 h-100">
                ...
                <div className="col-lg-6 d-flex align-items-center">
                  <div className="p-2 p-md-5 w-100">
                    ...
                    {/* <div className="text-center mb-4">
                      ...
                      <h2 className="fw-bold mb-2 signup-title">Join Our Community</h2>
                      <p className="text-muted mb-0 signup-subtitle">
                    ...
                    <div>
                      ...
                      <div className="mb-2">
                        ...
                        <div className="position-relative">
                          <input
                             ref={nameRef}
                            type="text"
                            className="form-control py-2 ps-4 pe-5 signup-input"
                      ...
                      <div className="mb-4">
                        <div className="form-check">
                          ...
                          >
                            ...
                            <a
                              href="#"
                              className="text-decoration-none terms-link"
                            >
                              Terms of Service
                            </a>{" "}
                            and{" "}
                      ...
                      <button
                        ...
                        onClick={()=>{handleBoth()}}
                        className="btn w-100 py-2 fw-bold position-relative overflow-hidden signup-btn"
                      >
                        {isLoading ? (
                      ...
                      <div className="row g-3 mb-1">
                        <div className="col-6">
                          <button
                            type="button"
                            className="btn w-100 py-2 border d-flex align-items-center justify-content-center social-btn"
                          >
                            <svg
                              className="me-2"
                              width="20"
                      ...
                      <p className="text-center mb-0 text-muted">
                        ...
                        <a
                          href="/login"
                          className="fw-semibold text-decoration-none login-link"
                        >
                          Sign in here
                        </a>
                      </p>
                ...
                {/* Animation Section */}
                <div className="col-lg-6 d-none d-lg-flex align-items-center justify-content-center position-relative animation-section">
                  {/* Background Pattern */}
                  ...
                  <div className="text-center position-relative">
                    ...
                    <p className="text-white opacity-75 mb-0 px-4">
                      Join our community of health-conscious food lovers and
